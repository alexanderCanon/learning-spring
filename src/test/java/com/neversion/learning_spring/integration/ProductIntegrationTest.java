...
@SpringBootTest // Carga todo el contexto de la aplicación Spring Boot (Base de datos,
                // Servicios, etc.)
...
class ProductIntegrationTest {
    ...
    public ProductIntegrationTest(MockMvc mockMvc, ProductRepository productRepository) {
